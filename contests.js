...
router.get("/contest-details", (req, res) => {
        ...
        connection.query(sqlCheckTeam, [contestId, userId], (err, teamResults) => {
          ...
          connection.query(sqlGetUser, [userId], (err, userResults) => {
            ...
            connection.query(sqlCreateTeam, [userId, contestId, squadCost], (err, teamResult) => {
              ...
              const playerValues = players.map(p => [teamId, p.athleteId, p.event_unit_cost || 0]);
              ...
              const sqlInsertPlayers = `INSERT INTO fantasy_team_entities (fantasy_team_id, athlete_id, cost) VALUES ${placeholders}`;
