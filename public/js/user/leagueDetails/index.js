...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    ...
    // 3) Inizializzo la pagina passando direttamente i dati raccolti
    ...
    // 4) registro eventuali altri eventi (per esempio l’accordion)
    bindLeagueEvents();
  } catch (err) {
  ...
  // 5) Pulsante “Back” (ritorno alla landing page)
